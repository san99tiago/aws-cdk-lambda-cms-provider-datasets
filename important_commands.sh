...
# Important: install Python dependencies on Lambda Layer (ONLY REFLECTED IN LOCAL COMPUTER, NOT IN GITHUB)
# --> Note: this should be run at the root of the repository (./)
# pip install beautifulsoup4 urllib3 --target=./lambda/layer/python
